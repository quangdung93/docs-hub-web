...
export const en: Record<MessageKey, string> = {
  ...
  'documents.delete.description':
    '"{name}" will leave the list and stop being used for retrieval.',
  ...
  'upload.documentVersion': 'Document version',
  'upload.documentVersionPlaceholder': 'e.g. 1.0 or September release',
  ...
  'upload.urdPrompt.title': 'URD document detected',
  'upload.urdPrompt.description': '"{name}" looks like a URD (User Requirement Document). Confirm to track its completeness and let AI analyse its edge cases?',
  'upload.urdPrompt.confirm': 'Yes, this is a URD',
  'upload.urdPrompt.reject': 'Not a URD',
  ...
  'edgeCase.analyzeFailed': 'Could not analyse this document.',
  'edgeCase.notReady': 'This document is not ready to analyse yet. Its canonical source has not finished building — try again once processing completes.',
  'edgeCase.saveFailed': 'Could not save the resolutions. Try again.',
  'edgeCase.saving': 'Saving…',
  'edgeCase.retry': 'Retry',
  'edgeCase.newRevision': 'A new URD revision was created from the resolutions.',
  'edgeCase.imageTooLarge': 'Image exceeds 5 MB.',
  ...
  'reports.planningHint': 'Project plan on the FTEL template',
  'reports.testcase': 'Test Case & Test Report',
  'reports.testcaseHint': 'SDLC test documentation set',
  'reports.generating': 'Generating…',
  'reports.generatingHint': 'This takes tens of seconds — keep the dialog open.',
  'reports.generateFailed': 'Could not generate the report.',
  'reports.download': 'Download',
  'reports.historyTitle': 'Export history',
  'reports.historyEmpty': 'No reports exported yet.',
  'reports.historyOpen': 'View export history',
  'reports.historyExpired': 'Links live for 15 minutes — reopen the list for fresh ones.',
