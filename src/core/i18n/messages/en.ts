...
export const en: Record<MessageKey, string> = {
  ...
  'reports.details': 'Acceptance details',
  'reports.detailsHint': 'These fill the report header. Leaving them blank is fine.',
  'reports.po': 'Product Owner',
  'reports.pm': 'Project Manager',
  'reports.scopeTest': 'Test scope',
  'reports.accountTest': 'Test account',
  'reports.startDate': 'Start date',
  'reports.dueDate': 'Due date',
  'reports.uatTemplate': 'UAT Report · ISC template',
  'reports.uatTemplateHint': 'Fills the standard form, with acceptance details',
  ...
  'reports.aiGroup': 'AI-written from the documents',
