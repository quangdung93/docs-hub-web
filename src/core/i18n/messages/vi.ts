...
export const vi = {
  ...
  'error.loadFailed': 'Không tải được nội dung',
  'documents.loadError': 'Không tải được danh sách tài liệu',
  'conversations.loadError': 'Không tải được danh sách hội thoại',
  'members.loadError': 'Không tải được danh sách thành viên',
  'projectAdmin.loadError': 'Không tải được dự án',
  ...
  'projectAdmin.logo': 'Logo dự án',
  'projectAdmin.logoHint': 'Bấm để tải ảnh mới lên.',
  'projectAdmin.logoUploading': 'Đang tải lên…',
  'projectAdmin.changeLogo': 'Đổi logo dự án',
  ...
  'documents.delete.title': 'Xóa tài liệu này?',
  'documents.delete.description':
    'Tài liệu "{name}" sẽ không còn trong danh sách và không được dùng để tra cứu nữa.',
  ...
  'upload.documentVersion': 'Phiên bản tài liệu',
  'upload.documentVersionPlaceholder': 'Ví dụ: 1.0 hoặc bản phát hành tháng 9',
  ...
  'upload.urdPrompt.title': 'Phát hiện tài liệu URD',
  'upload.urdPrompt.description': 'Hệ thống nhận diện tệp "{name}" có thể là tài liệu URD (User Requirement Document). Xác nhận để bật theo dõi độ hoàn thiện và cho phép AI phân tích edge case cho tài liệu này?',
  'upload.urdPrompt.confirm': 'Đúng, đây là URD',
  'upload.urdPrompt.reject': 'Không phải URD',
  ...
  'versions.initialPrompt': 'Tên phiên bản khởi tạo của dự án',
  'versions.initialHint': 'Snapshot đầu tiên của cả dự án — mọi tệp tải lên ở bước này sẽ thuộc về nó.',
  ...
  // ── Quản lý phiên bản ────────────────────────────────────────────────────
  'versions.note': 'Ghi chú thay đổi (tuỳ chọn)',
  'versions.notePlaceholder': 'Mô tả ngắn những gì đã thay đổi so với phiên bản trước…',
  'versions.tab': 'Phiên bản',
  'versions.sectionTitle': 'Phiên bản dự án (snapshot)',
  'versions.sectionHint': 'Mỗi phiên bản ghi lại tài liệu của dự án tại một thời điểm.',
  'versions.createNew': 'Tạo phiên bản mới',
  'versions.modalTitle': 'Tạo phiên bản dự án mới',
  'versions.modalDescription':
    'Lưu lại trạng thái tài liệu hiện tại của dự án thành một phiên bản có thể xem lại sau này.',
  'versions.nameRequired': 'Vui lòng nhập tên phiên bản.',
  'versions.nameHint': 'Đặt tên tự do — không bắt buộc theo định dạng vX.Y.',
  'versions.empty': 'Dự án chưa có phiên bản nào.',
  'versions.loadError': 'Không tải được danh sách phiên bản.',
  'versions.current': 'Mới nhất',
  'versions.documentCount': '{count} tài liệu',
  'versions.status.draft': 'Bản nháp',
  ...
  'edgeCase.analyzeFailed': 'Không phân tích được tài liệu này.',
  'edgeCase.notReady': 'Tài liệu chưa sẵn sàng để phân tích. Nguồn canonical của bản revision chưa được tạo xong — thử lại sau khi tài liệu xử lý xong.',
  'edgeCase.saveFailed': 'Không lưu được hướng giải quyết. Thử lại.',
  'edgeCase.saving': 'Đang lưu…',
  'edgeCase.retry': 'Thử lại',
  'edgeCase.newRevision': 'Đã tạo một bản revision URD mới từ các hướng giải quyết.',
  'edgeCase.imageTooLarge': 'Ảnh vượt quá 5 MB.',
  ...
  'reports.planningHint': 'Kế hoạch dự án theo biểu mẫu FTEL',
  'reports.testcase': 'Test Case & Test Report',
  'reports.testcaseHint': 'Bộ tài liệu kiểm thử theo quy trình SDLC',
  'reports.generating': 'Đang tổng hợp…',
  'reports.generatingHint': 'Quá trình này mất vài chục giây, đừng đóng cửa sổ.',
  'reports.generateFailed': 'Không tổng hợp được báo cáo.',
  'reports.download': 'Tải file',
  'reports.historyTitle': 'Lịch sử xuất báo cáo',
  'reports.historyEmpty': 'Dự án chưa xuất báo cáo nào.',
  'reports.historyOpen': 'Xem lịch sử xuất',
  'reports.historyExpired': 'Link tải chỉ sống 15 phút, mở lại danh sách để lấy link mới.',
