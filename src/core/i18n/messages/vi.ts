...
export const vi = {
  ...
  'reports.uatHint': 'Test case từ User Story / AC',
  'reports.rtm': 'Requirement Traceability Matrix',
  'reports.tsr': 'Test Summary Report',
  'reports.comingSoon': 'Sắp có',
  'reports.modalTitle': 'Xuất UAT Report',
  'reports.modalDescription':
    'Tổng hợp các User Story / AC trong dự án thành file UAT Report để đội QC ký nghiệm thu.',
  'reports.scope': 'Phạm vi dữ liệu',
  'reports.scopeHint': 'Chọn phiên bản dự án muốn xuất báo cáo.',
  ...
  'reports.details': 'Thông tin nghiệm thu',
  'reports.detailsHint': 'Các trường này được điền vào phần đầu báo cáo. Bỏ trống cũng được.',
  'reports.po': 'Product Owner',
  'reports.pm': 'Project Manager',
  'reports.scopeTest': 'Phạm vi kiểm thử',
  'reports.accountTest': 'Tài khoản kiểm thử',
  'reports.startDate': 'Ngày bắt đầu',
  'reports.dueDate': 'Ngày kết thúc',
  'reports.uatTemplate': 'UAT Report · template ISC',
  'reports.uatTemplateHint': 'Điền tài liệu vào biểu mẫu chuẩn, có phần thông tin nghiệm thu',
  ...
  'reports.aiGroup': 'AI tổng hợp từ tài liệu',
