...
const members: ProjectMemberDto[] = [
  {
    ...
    project_id: 'p2',
    user_id: 'u-viettq45',
    user: { id: 'u-viettq45', full_name: 'Việt Trịnh Quốc', email: 'viettq45@docshub.io.vn' },
    role: 'owner',
    status: 'active',
  ...
  },
  {
    ...
    project_id: 'p2',
    user_id: 'u-phongdt29',
    user: { id: 'u-phongdt29', full_name: 'Phong Đỗ Thanh', email: 'phongdt29@docshub.io.vn' },
    role: 'editor',
    status: 'active',
  ...
  },
  {
    ...
    project_id: 'p2',
    user_id: 'u-dungvq11',
    user: { id: 'u-dungvq11', full_name: 'Dũng Vũ Quang', email: 'dungvq11@docshub.io.vn' },
    role: 'editor',
    status: 'active',
    invited_at: ago(89 * DAY),
    joined_at: ago(89 * DAY),
